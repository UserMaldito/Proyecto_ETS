...
namespace Proyecto_ETS
{
	public class Datos
	{
		...
		public static int ObtenerAnoUnitTest(int ano, ref bool bisiesto)
		{
			if ((ano > 0) && (ano <= 9999))
			{
				bisiesto = DateTime.IsLeapYear(ano);
		...
		public static int ObtenerMesUnitTest(int mes)
		{
			if (!((mes > 0) && (mes < 13)))
			{
				mes = -1;
		...
		public static int ObtenerDiaUnitTest(int dia, int mes, bool bisiesto)
		{
			switch (mes)
			{
				//StackOverflow es hermoso: https://stackoverflow.com/questions/848472/how-add-or-in-switch-statements (stackeando case == or)
				case 1:
				case 3:
				case 5:
				case 7:
